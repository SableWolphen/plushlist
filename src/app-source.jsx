...
function GlowUpTracker() {
  ...
  <button type="button" onClick={() => setPendingTaskDelete(null)} style={{ padding: "8px 12px", borderRadius: 10, border: "1px solid #D8C8E2", background: "white", color: "#76558A", fontWeight: 900 }}>Keep task</button>
      ...
      <div
        ...
        {dashboard !== "today" && <div className="plushlife-app-header" style={{ marginBottom: 14, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
        ...
        {dashboard !== "today" && user && (betaBannerDismissed ? (
        ...
        {dashboard !== "today" && <div className="plushlife-dashboard-nav" style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
