  ...
  return (
    <>
      <style>{`
        ...
        .pl-home-hero{position:relative;min-height:305px;margin:-18px -14px 0;overflow:hidden;border-radius:0 0 28px 28px;background:linear-gradient(135deg,#FFF6F6 0%,#F8ECF8 54%,#EFE6F6 100%);box-shadow:inset 0 -10px 28px rgba(118,75,132,.04)}
