  ...
  return (
    <>
      <style>{`
        ...
        .pl-home-hero{position:relative;min-height:305px;margin:-18px -14px 0;overflow:hidden;border-radius:0 0 28px 28px;background:linear-gradient(135deg,rgba(255,246,248,.92) 0%,rgba(248,236,248,.86) 54%,rgba(239,230,246,.84) 100%);box-shadow:inset 0 -10px 28px rgba(118,75,132,.04)}
        ...
        .pl-home-copy{left:28px;bottom:30px;width:48%;}.pl-home-copy h1{margin:0;font-size:33px;line-height:1.08;color:#402456;font-weight:950;letter-spacing:-1px}.pl-home-copy p{margin:10px 0 0;font-size:17px;line-height:1.38;color:#60486F;font-weight:650}
        .pl-home-plush{right:4px;bottom:-2px;width:47%;height:70%;display:flex;align-items:flex-end;justify-content:center}.pl-home-plush img{position:relative;z-index:3;width:min(205px,80%);max-height:190px;object-fit:contain;filter:drop-shadow(0 10px 14px rgba(73,39,87,.12))}.pl-home-pillow{position:absolute;border-radius:50%;background:radial-gradient(circle at 40% 35%,#FCEBED,#EEDAF5 58%,#D9C2E6);box-shadow:inset 0 0 38px rgba(255,255,255,.72)}.pl-pillow-one{right:-10px;bottom:-32px;width:268px;height:170px;transform:rotate(-7deg)}.pl-pillow-two{right:80px;bottom:-18px;width:185px;height:118px;transform:rotate(9deg);opacity:.9}.pl-mini-plush{position:absolute;z-index:4;left:26%;bottom:31px;font-size:42px;transform:rotate(-9deg);filter:drop-shadow(0 4px 5px rgba(90,57,102,.16))}
        ...
        @media(max-width:520px){
          .pl-home-shell{gap:10px}
          .pl-home-hero{min-height:258px;margin:-16px -10px 0;border-radius:0 0 24px 24px}
          .pl-home-brand{left:18px;top:18px}.pl-home-logo{font-size:27px}.pl-home-tagline{font-size:11.5px;margin-top:5px}
          .pl-home-actions{right:12px;top:15px;gap:7px}.pl-home-date{font-size:10px;padding:8px 10px}.pl-home-settings{width:38px;height:38px;font-size:18px}
          .pl-home-window{left:9%;top:54px;width:41%;height:68px}.plant-a{font-size:42px;top:78px}.plant-b{font-size:38px;top:76px;right:20px}
          .pl-home-copy{left:18px;bottom:24px;width:51%}.pl-home-copy h1{font-size:25px;line-height:1.08}.pl-home-copy p{margin-top:8px;font-size:13.5px;line-height:1.38}
          .pl-home-plush{right:-4px;bottom:-2px;width:45%;height:65%}.pl-home-plush img{width:min(160px,76%);max-height:150px}.pl-pillow-one{width:190px;height:118px}.pl-pillow-two{width:135px;height:86px}.pl-mini-plush{font-size:30px;left:22%;bottom:25px}
          .pl-home-bubble{right:9px;bottom:8px;font-size:9.5px;padding:7px 10px;border-radius:14px}
          .pl-section-topline{align-items:center}.pl-kicker{font-size:10.5px}.pl-muted-note{max-width:47%;font-size:9.3px}
          .pl-primary-task{font-size:17px;margin-top:7px}.pl-action-row{gap:7px;margin-top:10px}.pl-btn,.pl-more{min-height:42px}.pl-btn{padding:8px 9px;font-size:10.8px}.pl-more{width:44px}
          .pl-list{margin-top:10px;gap:6px}.pl-list-row{min-height:46px;padding:7px 10px;border-radius:13px}.pl-schedule-row{grid-template-columns:70px 22px minmax(0,1fr) 11px}.pl-note-row{grid-template-columns:22px minmax(0,1fr)}.pl-time{font-size:13px}.pl-row-icon{font-size:16px}.pl-row-text{font-size:12.5px}.pl-check{width:23px;height:23px;border-radius:7px}
          .pl-home-shortcuts{gap:8px}.pl-shortcut{min-height:68px;padding:10px 11px;border-radius:17px}.pl-shortcut-icon{font-size:24px}.pl-shortcut-title{font-size:12.5px}.pl-shortcut-sub{font-size:9.5px}.pl-shortcut-arrow{font-size:19px}
          .pl-noticed{min-height:54px;border-radius:17px;padding:9px 12px}.pl-noticed-icon{font-size:23px}.pl-noticed-title{font-size:11.5px}.pl-noticed-copy{font-size:9.8px}.pl-noticed-arrow{font-size:19px}
        }
      `}</style>
