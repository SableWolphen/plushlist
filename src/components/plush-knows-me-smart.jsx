import { PlushKnowsMe as PlushKnowsMeCore } from "./plush-knows-me.jsx";
...
export function PlushKnowsMe(props) {
  ...
  return <>
    <PlushKnowsMeCore {...props} />
    <section data-plush-smarter-adaptation="true" aria-label="Smarter PlushLife patterns" style={{ display: "grid", gap: 8, margin: "0 0 10px" }}>
      {gold && sequence && <div style={{ ...card, borderColor: "#CFE8E1", background: "linear-gradient(145deg,#F3FFFB,#FFFFFF)" }}>
      ...
      {gold && recovery && <div style={{ ...card, borderColor: "#DDD0E9", background: "linear-gradient(145deg,#FAF5FD,#FFFFFF)" }}>
