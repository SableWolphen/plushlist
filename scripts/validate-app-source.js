...
const requiredRegressionMarkers = [
  ...
  'MY LITTLE NURSERY',
  'function BabyModeCareSuite({ date, todayDone, todayTotal, activityDays, careDays, caregiverName, comfortItemName, littleJobs, onCompleteTask, onOpenJournal, onSoftDay })',
  'LITTLE CARE CORNER',
  'BEDTIME WIND-DOWN',
