...
const checks = [
  [source.includes("YOUR TINY THING"), "Baby Mode keeps one primary tiny thing"],
  [source.includes("Tuck it in") && source.includes("Make it tinier"), "primary task has only two obvious actions"],
